...
resource "aws_security_group" "chat_server_sg" {
  ...
  ingress {
    ...
    to_port          = 5555
    protocol         = "tcp"
    cidr_blocks      = ["82.64.73.178/32","90.3.0.106/32","176.158.166.180/32","80.215.38.198/32","88.123.159.229/32","80.215.166.202/32","176.175.33.174/32"]
  }
  ...
  ingress {
    ...
    to_port          = 22
    protocol         = "tcp"
    cidr_blocks      = ["82.64.73.178/32","90.3.0.106/32","176.158.166.180/32","80.215.38.198/32","88.123.159.229/32","10.0.4.0/32","176.175.33.174/32"]
  }
